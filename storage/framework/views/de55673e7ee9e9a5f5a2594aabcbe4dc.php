            ...
            <div class="card shadow-lg border-accent">
                <div class="card-header bg-dark d-flex justify-content-between align-items-center py-3">
                    <h5 class="mb-0">
                        ...
                        AI TRAINING ENGINE: <?php echo e(strtoupper($class->display_name)); ?>
                ...
                <div class="card-body p-4">
                    ...
                    <div class="row text-center mb-5 mt-3">
                        <div class="col-4">
                            ...
                            <h2 id="epochText" class="mb-0">0 / <?php echo e($class->training_epochs); ?></h2>
                        </div>
                ...
                <div class="card-footer bg-surface border-border p-3 d-flex justify-content-between align-items-center">
                    ...
                    <a href="<?php echo e(route('training.index')); ?>" class="btn btn-sm btn-outline-light border-border px-4 py-2 opacity-50" id="returnBtn">
...
<script>
    ...
    const totalEpochs = <?php echo e($class->training_epochs); ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mahadi Hassan Arif\Desktop\Camera Tracking\sentinel\resources\views\training\progress.blade.php ENDPATH**/ ?>