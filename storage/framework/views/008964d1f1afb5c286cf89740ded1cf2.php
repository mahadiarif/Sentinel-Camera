...
<div style="display:flex;flex-direction:column;gap:20px;">
    ...
    <div style="display:grid;grid-template-columns:repeat(4,1fr);gap:16px;">
        ...
        <div class="stat-card cyan">
            ...
            <div class="stat-value text-cyan" id="summaryAlerts"><?php echo e($stats['total_detections']); ?></div>
            <div class="stat-label">Total Shop Visits</div>
        </div>

        <div class="stat-card green">
            <div class="stat-icon text-green"><i class="fas fa-user-check"></i></div>
            <div class="stat-value text-green" id="summaryPersons"><?php echo e($stats['person_count']); ?></div>
    ...
    <div style="display:grid;grid-template-columns:1fr 380px;gap:20px;align-items:start;">
        ...
        <div class="card" style="overflow:hidden;">
            ...
            <div style="position:relative;background:#000;height:460px;overflow:hidden;">
                <img id="gateFeed"
                     src="<?php echo e(asset('gate_frames/cam_' . ($cameras->first()->id ?? 1) . '.jpg')); ?>?t=<?php echo e(now()->timestamp); ?>"
            ...
            <div class="card">
                ...
                <div class="card-body" style="padding:12px;">
                    <div id="snapshotGrid"
                        ...
                        <a href="<?php echo e(asset('gate_snapshots/' . basename($snap->snapshot_path))); ?>" target="_blank"
                           style="border-radius:6px;overflow:hidden;display:block;aspect-ratio:1;
                                  background:var(--surface2);">
                            <img src="<?php echo e(asset('gate_snapshots/' . basename($snap->snapshot_path))); ?>"
                                 style="width:100%;height:100%;object-fit:cover;transition:transform 0.2s;"
                                 onmouseover="this.style.transform='scale(1.05)'"
                                 onmouseout="this.style.transform='scale(1)'">
                        </a>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                        <?php if($recent_snapshots->isEmpty()): ?>
