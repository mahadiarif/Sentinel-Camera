...
<div class="container-fluid">
    <div class="row align-items-center mb-4">
        <div class="col-md-6">
            ...
            <p class="text-dim opacity-75">DATASET: <?php echo e($class->display_name); ?> (<?php echo e($class->labeled_count); ?> / <?php echo e($class->training_images_count); ?> LABELED)</p>
        </div>
        <div class="col-md-6 text-md-end">
            ...
            <a href="<?php echo e(route('training.index')); ?>" class="btn btn-surface2 border-border">
            ...
            <div class="card h-100">
                ...
                <div class="card-footer d-flex justify-content-between align-items-center bg-surface py-3">
                    <div class="text-dim small">
                        ...
                        CLICK AND DRAG TO DRAW BOUNDING BOX AROUND <b><?php echo e(strtoupper($class->display_name)); ?></b>
                    </div>
...
<script>
    ...
    function selectImage(idx) {
        ...
        document.getElementById('currentFileName').innerText = imgObj.id + '.jpg / TARGET: ' + '<?php echo e(strtoupper($class->display_name)); ?>';
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Mahadi Hassan Arif\Desktop\Camera Tracking\sentinel\resources\views\training\label.blade.php ENDPATH**/ ?>